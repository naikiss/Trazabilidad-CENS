...
// Asigna la función a cada fila de la tabla
var filas = document.getElementsByTagName('tr');
for (var i = 0; i < filas.length; i++) {
  filas[i].addEventListener('click', function() {
    // Obtén la URL de la fila (puedes personalizar esto según tu estructura de tabla)
    var url = this.getAttribute('data-url');
    
    // Redirige a la página con la URL
    redirigirAPagina(url);
  });
}
